<div class="container-fluid nav-bar bg-transparent">
    <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
        ...
        <div class="profile-menu">
            ...
            @endphp
            <button class="user_account d-lg-flex" style="background-image:url('{{ $customer->customer_profile_pic === 'none' ? asset('User/Customer/placeholder.png') : asset('User/Customer/'.$customer->customer_profile_pic) }}')"></button>
