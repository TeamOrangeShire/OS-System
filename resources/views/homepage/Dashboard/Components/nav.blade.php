...
@endphp
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ $profile_pic === 'none' ? asset('User/Customer/placeholder.png') : 'https://orangeshire.com/repositories'.Storage::url('UserPic/Customer/'.$profile) }}" alt="Profile" class="rounded-circle">
...
{{-- 
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{ route('customerReservation') }}">
