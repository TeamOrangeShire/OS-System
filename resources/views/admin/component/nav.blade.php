        ...
        <div class="navbar-content scroll-div " >
            ...
            <div class="">
                <div class="main-menu-header">
                    <img class="img-radius" src="{{ asset('User/Admin/'.$admin_name->admin_profile_pic)}}"  alt="User-Profile-Image">
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item">
                    <a href="{{route('salesreports')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-percent"></i></span><span class="pcoded-mtext">Sales Report</span></a>
                </li>
